            ...
            <div class="product-single__image">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('uploads/products')}}/{{$gallery_images}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{asset('uploads/products')}}/{{$gallery_images}}" data-bs-toggle="tooltip"
                      data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      ...
                      @foreach (explode(',',$product->images) as $gallery_images)
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products')}}/{{$gallery_images}}" width="104" height="104" alt="" /></div>
                      @endforeach
                </div>
              </div>
            </div>
              ...
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.detail',['product_slug'=>$rproduct->slug])}}">
                  <img loading="lazy" src="{{asset('uploads/products')}}/{{$rproduct->image}}" width="330" height="400"
                    ...
                    @foreach (explode(',',$rproduct->images) as $gallery_images)
                  <img loading="lazy" src="{{asset('uploads/products')}}/{{$gallery_images}}" width="330" height="400"
