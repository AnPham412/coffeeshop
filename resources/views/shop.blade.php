            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route('shop.product.detail',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$product->image}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                    </div>
                    <!-- gallery -->
                    <div class="swiper-slide">
                      @foreach (explode(',',$product->images) as $gallery_images)
                      <a href=""><img loading="lazy" src="{{asset('uploads/products')}}/{{$gallery_images}}"
              ...
              <div class="pc__info position-relative" >
                <p display="hidden" class="pc__category">{{$product->category->name}}</p>
